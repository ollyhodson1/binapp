...
- Cloudflare Worker URL has been inserted:

```text
https://bin-buddy-oldham.oliverhodson1234.workers.dev/
```

- Removed the visible literal `\n`.
- Removed the temporary v4 marker from the app screen.
- Kept the cache-clearing script so old GitHub Pages/service-worker files do not keep showing.

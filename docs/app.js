...
// 2) Paste the Worker URL below, or tap the refresh button 7 times in the app to save it there.
const WORKER_URL = ""; // Example: "https://bin-buddy-oldham.your-name.workers.dev"

// Demo data is used until WORKER_URL is set or a saved Worker URL exists.
